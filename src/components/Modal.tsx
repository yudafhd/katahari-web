            ...
            <div className={containerCls}>
                ...
                {(title || onClose) ? (
                    <div className="mb-2 flex items-center justify-between">
                        {title ? <h2 className="text-white font-semibold opacity-90">{title}</h2> : <span />}
                        <button
                            onClick={onClose}
                            aria-label="Close modal"
                            className="inline-flex text-white items-center justify-center rounded-md h-8 w-8 hover:bg-black/5 dark:hover:bg-white/10"
                        >
